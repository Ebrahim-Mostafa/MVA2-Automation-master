...
public class CheckBehaviourWhenCallsandLocationOFF_3 extends BaseTest {
/*
...
*/
    @Test
    public static void CheckBehaviourWhenCallsLocationOFF() throws InterruptedException, IOException {
        ...
        element(ObjectRepo.id_overlay_positive_btn).click();
        wait(2);
        element(ObjectRepo.Checkbox_Location_switch).click();
        Utils.ReOpenApp();
