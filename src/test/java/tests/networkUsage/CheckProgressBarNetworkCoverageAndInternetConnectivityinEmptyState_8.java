...
public class CheckProgressBarNetworkCoverageAndInternetConnectivityinEmptyState_8 extends BaseTest {
/*
...
*/
    @Test
    public static void CheckProgressBarNetworkCoverageAndInternetConnectivityinEmptyState() throws InterruptedException, IOException {
        ...
        soft.assertEquals(element(ObjectRepo.Internet_Connectivity_Network).getText(),
                "0%", "Internet Coverage Should be Equal 0% ");
        soft.assertAll();
    }
}