...
public class CheckSpeedTestAfterAllowPermission_12 extends BaseTest {

    @Test
    public static void CheckSpeedTestAfterAllowPermission() throws InterruptedException, IOException {
